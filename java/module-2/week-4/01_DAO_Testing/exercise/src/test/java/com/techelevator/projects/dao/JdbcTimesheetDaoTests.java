...
public class JdbcTimesheetDaoTests extends BaseDaoTests {
    ...
    public void setup() {
        ...
        testTimesheet = new Timesheet(0, 1, 2,
                LocalDate.parse("2021-01-01"), 1.0, true, "Timesheet 0");
    }
    ...
    public void getTimesheet_returns_null_when_id_not_found() {
        ...
        Timesheet timesheet = dao.getTimesheet(50);
    ...
    public void updated_timesheet_has_expected_values_when_retrieved() {
        ...
        timesheetToUpdate.setDescription("Timesheet 15");
